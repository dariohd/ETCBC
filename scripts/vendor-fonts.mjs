/**
 * Télécharge les polices et génère fonts/fonts.css
...
const SPEC = {
  ...
  files: [
    { file: 'cormorant-500.woff2', family: 'Cormorant Garamond', weight: 500 },
    { file: 'cormorant-600.woff2', family: 'Cormorant Garamond', weight: 600 },
    { file: 'cormorant-700.woff2', family: 'Cormorant Garamond', weight: 700 },
    { file: 'dmsans-400.woff2', family: 'DM Sans', weight: 400 },
    { file: 'dmsans-500.woff2', family: 'DM Sans', weight: 500 },
    { file: 'dmsans-600.woff2', family: 'DM Sans', weight: 600 },
    { file: 'dmsans-700.woff2', family: 'DM Sans', weight: 700 },
  ],
};
